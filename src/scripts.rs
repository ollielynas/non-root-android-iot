pub const TEST_LOG_SCRIPT: &str = include_str!("scripts/do_something.sh");
...
pub const ACCELERATION_SCRIPT: &str = include_str!("scripts/log_acc.sh");
...
pub const ELEVATION_SCRIPT: &str = include_str!("scripts/log_elevation.sh");
pub const GPS_SCRIPT: &str = include_str!("scripts/log_gps.sh");
pub const NTP_SCRIPT: &str = include_str!("scripts/log_ntp.sh");
pub const PING_SCRIPT: &str = include_str!("scripts/log_ping.sh");
pub const LIGHT_SCRIPT: &str = include_str!("scripts/log_light.sh");
pub const PROXIMITY_SCRIPT: &str = include_str!("scripts/log_proximity.sh");
pub const GYRO_SCRIPT: &str = include_str!("scripts/log_gyro.sh");
pub const MAGNETIC_SCRIPT: &str = include_str!("scripts/log_magnetic.sh");
pub const PRESSURE_SCRIPT: &str = include_str!("scripts/log_pressure.sh");
pub const HUMIDITY_SCRIPT: &str = include_str!("scripts/log_humidity.sh");
pub const STEPS_SCRIPT: &str = include_str!("scripts/log_steps.sh");
pub const GRAVITY_SCRIPT: &str = include_str!("scripts/log_gravity.sh");
pub const LINEAR_ACC_SCRIPT: &str = include_str!("scripts/log_linear_acc.sh");
pub const ROTATION_SCRIPT: &str = include_str!("scripts/log_rotation.sh");
...
pub const SCRIPTS: &[(&str, &str)] = &[
    ...
    ("upload.sh", UPLOAD_SCRIPT),
    ("log_battery.sh", BATTERY_SCRIPT),
    ("log_acc.sh", ACCELERATION_SCRIPT),
    ("log_bluetooth.sh", BLUETOOTH_SCRIPT),
    ("log_data_usage.sh", DATA_USAGE_SCRIPT),
    ("log_elevation.sh", ELEVATION_SCRIPT),
    ("log_gps.sh", GPS_SCRIPT),
    ("log_ntp.sh", NTP_SCRIPT),
    ("log_ping.sh", PING_SCRIPT),
    ("log_light.sh", LIGHT_SCRIPT),
    ("log_proximity.sh", PROXIMITY_SCRIPT),
    ("log_gyro.sh", GYRO_SCRIPT),
    ("log_magnetic.sh", MAGNETIC_SCRIPT),
    ("log_pressure.sh", PRESSURE_SCRIPT),
    ("log_humidity.sh", HUMIDITY_SCRIPT),
    ("log_steps.sh", STEPS_SCRIPT),
    ("log_gravity.sh", GRAVITY_SCRIPT),
    ("log_linear_acc.sh", LINEAR_ACC_SCRIPT),
    ("log_rotation.sh", ROTATION_SCRIPT),
